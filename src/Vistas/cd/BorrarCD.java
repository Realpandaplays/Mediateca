 ...
 */
public class BorrarCD extends javax.swing.JFrame {
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        ...
        if (eleccion == JOptionPane.YES_OPTION){
            if (MaterialCD.EliminarMaterialCD(txtId.getText().trim())){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarCD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
