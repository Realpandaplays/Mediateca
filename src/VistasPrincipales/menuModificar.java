...
public class menuModificar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtModificar.setFont(new java.awt.Font("Rockwell", 1, 36)); // NOI18N
        ...
        txtModificar.setText("MODIFICAR MATERIAL");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtModificar, javax.swing.GroupLayout.PREFERRED_SIZE, 630, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27))
        );
    ...
    private void btnLibroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLibroMouseClicked
        Modificar mLibro = new Modificar();
    ...
    private void btnRevistaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRevistaMouseClicked
        ModificarR mRevista = new ModificarR();
        mRevista.setVisible(true);
        this.dispose();
    ...
    private void btnDvdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDvdMouseClicked
        Vistas.dvd.ModificarDVD dvdConsultar = new Vistas.dvd.ModificarDVD();
